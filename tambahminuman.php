...
<body>
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li><a href="makananminumanpaket.php">Tambah Makanan</a></li>
				<li class="active"><a href="tambahminuman.php">Tambah Minuman</a></li>
	...
	<form class="form-horizontal" method="post" action="listmenu.php">
		<div class="form-group">
			<label class="col-sm-2 control-label">Nama Minuman</label>
			<div class="col-sm-7">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label">Harga Minuman</label>
			<div class="col-sm-7">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label">Detail Minuman</label>
			<div class="col-sm-7">
		...
		<div class="form-group"> 
			<div class="col-sm-offset-2 col-sm-10">
				<button type="submit" class="btn btn-default"><a href="listmenuminuman.php">Tambah List Menu</button>
